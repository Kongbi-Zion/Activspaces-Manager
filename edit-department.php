...
<head>
    ...
    <title>Edit Department | Kiaalap - Kiaalap Admin Template</title>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                         ...
                         <li>
                            <a class="has-arrow" href="all-courses.html" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">services</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All services" href="all-services.html"><span class="mini-sub-pro">All services</span></a></li>
                                <li><a title="Add services" href="add-services.html"><span class="mini-sub-pro">Add services</span></a></li>
                                <li><a title="Edit services" href="edit-services.html"><span class="mini-sub-pro">Edit services</span></a></li>
                                <li><a title="profile Profile" href="services-info.html"><span class="mini-sub-pro">services Info</span></a></li>
                                <li><a title="profile Payment" href="services-payment.html"><span class="mini-sub-pro">services Payment</span></a></li>
                            </ul>
                        </li>
                        <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Department</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="col-lg-6">
														<div class="devit-card-custom">
															<div class="form-group">
																<input name="number" type="text" class="form-control" placeholder="Name" value="CSE">
															</div>
															<div class="form-group">
																<input type="text" class="form-control" placeholder="Head" value="John Alva">
															</div>
															<div class="form-group">
																<input type="text" class="form-control" placeholder="Email" value="john@gmail.com">
															</div>
														</div>
                                                    </div>
                                                    <div class="col-lg-6">
														<div class="devit-card-custom">
															...
															<div class="form-group">
																<input type="text" class="form-control" placeholder="No. of Students" value="1500">
															</div>
															<div class="form-group">
																<input type="text" class="form-control" placeholder="Status" value="Active">
															</div>
														</div>
                                                    </div>
                                                </div>
