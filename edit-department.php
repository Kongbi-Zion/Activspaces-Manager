                            ...
                            <div class="">      
                                       ...
                                       <div class="container">
                                            ...
                                            <div class="card-header py-3">
                                                <h2 class="m-0 font-weight-bold text-primary">Edit Subscription</h2>
                                            </div>
                                            <br><br>
                                                ...
                                                <form action="php-code.php" method="POST">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Subscription period</label>
                                                        <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label"><?php echo $row['prenom'];  ?></label>
                                                        <div class="col-sm-7">
